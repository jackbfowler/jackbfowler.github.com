...
export const experienceData = [
    ...
    {
        id: 5,
        company: "Local Machine Shop",
        role: "Machinist Apprentice",
        startDate: "2022-05-01",
        endDate: "2022-08-01",
        semesterStart: 6,
        semesterEnd: 7,
        description: "Operated CNC mills and lathes. Gained hands-on experience with GD&T and manufacturing tolerances.",
        logo: FORMLABS,
        color: "#2A60C1",
        track: 3 // Reverted to 3
    },
